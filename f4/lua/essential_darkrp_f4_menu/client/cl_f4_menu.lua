...
local defaultBlur = Color(45, 45, 45, 255)
local defaultBlurOutline = Color(100, 100, 100, 255)

local buttonHovered = Color(211, 84, 0)

local tabsHeaderColor = Color(25, 25, 25, 255)
local tabsColor = Color(25, 25, 25, 255)

local tabButtonHeight = 75
...
local function drawTabsPanel()
	...
	for i = 1, #tabs do
		...
		function tab:Paint(w, h)
			if self:IsHovered() then
				tab:SetTextColor(Color(211, 84, 0))
			else
				tab:SetTextColor(white)
			end
	...
	function closeButton:Paint()
		if self:IsHovered() then
			closeButton:SetTextColor(Color(211, 84, 0))
		else
			closeButton:SetTextColor(white)
		end
