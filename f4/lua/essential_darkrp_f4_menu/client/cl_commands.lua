...
rowOneCommands[onePos]	= {
	cmd = '/cheque',
	text = 'Scheck schreiben',
	argAmount = 2,
	argOne = 'Player',
	argTwo = 'Number',
	placeholder = 'Geld: Betrag'
}
...
rowFourCommands[fourPos] = {
	cmd = '/unwarrant',
	text = 'Durchsuchungsbefehl Stoppen',
	argAmount = 1,
	argOne = 'Player',
	cpOnly = true
}
